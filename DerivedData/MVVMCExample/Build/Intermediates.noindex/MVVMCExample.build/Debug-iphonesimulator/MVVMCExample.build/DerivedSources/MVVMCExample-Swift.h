...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVVMCExample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12MVVMCExample11AppDelegate")
...
SWIFT_CLASS("_TtC12MVVMCExample21BookListTableViewCell")
...
SWIFT_CLASS("_TtC12MVVMCExample20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleDetailLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified bookImage;
...
SWIFT_CLASS("_TtC12MVVMCExample16SceneCoordinator")
...
@interface SceneCoordinator (SWIFT_EXTENSION(MVVMCExample)) <UITabBarControllerDelegate>
...
@interface SceneCoordinator (SWIFT_EXTENSION(MVVMCExample)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC12MVVMCExample13SceneDelegate")
...
SWIFT_CLASS("_TtC12MVVMCExample14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified booksTableView;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ViewController (SWIFT_EXTENSION(MVVMCExample)) <UITableViewDataSource, UITableViewDelegate>
